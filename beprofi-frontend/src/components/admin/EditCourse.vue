            ...
            <div class="modal-container">
                              ...
                              <div class="row">
                                <div class="col-md-4 form">
                                  ...
                                  <div class="col-md-8">
                                    ...
                                    <option v-for="category in $t('menu.courses.services')" :key="category.id">{{ category.title }}</option>
                                  </select> 
                                  </div>
                                </div>
                                <div class="row">
              ...
              <div class="modal-footer">
                <slot name="footer">
                  ...
                  <button class="modal-default-button" @click="editCourse()">
                    {{ $t('modal.add') }}
                  </button>
                </slot>
              </div>
