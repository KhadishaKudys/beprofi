          ...
          <div class="modal-wrapper">
            <div class="modal-container">
              ...
              <div class="modal-body">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">{{ $t('modal.syllabusService') }}</a>
                </li>
                </ul>
                        ...
                        <div class="col-md-6">
                              <div class="row">
                                <div class="col-md-4 form">
                                  <label for="category">{{ $t('modal.category') }}:</label>
                                </div>
                                  <div class="col-md-8">
                                    <select v-model="category" id="category">
                                    <option v-for="item in $t('menu.services.list')" :key="item.id" :value="item.id">{{ item.name }}</option>
                                  </select> 
                                  </div>
                                </div>
                                <div class="row">
                                <div class="col-md-4 form">
                                  ...
                                  <div class="col-md-8">
                                    ...
                                    <option v-for="category in $t(`menu.services.${category}.services`)" :key="category.id" :value="category.id">{{ category.title }}</option>
                                  </select> 
                                  </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="col-md-4 form">
                                  ...
                                  <div class="col-md-8">
                                      ...
                                      <select v-model="currency" id="currency" style="margin:0px; margin-left:25px">
                                        <option>USD</option>
                                        <option>KZT</option>
                                      </select>
                                  </div>
                                ...
                                <div class="row">
                                <div class="col-md-4 form">
                                  <label for="level">Рекомендуемый:</label>
                                </div>
                                  <div class="col-md-8">
                  ...
                  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <label for="overview">{{ $t('modal.overviewService') }}:</label>
...
export default {
    ...
    methods: {
      ...
      addItem(){
        ...
        formData.append("servicesProductDTO", JSON.stringify(this.product));
      formData.append("image", this.files);
      console.log(...formData.entries());
      const waitTime = 25000;
            setTimeout(() => console.log("Request taking a long time"), waitTime);
            axios.post('http://localhost:8086/api/v1/services/products/save', formData, {
              headers:{
