  ...
  <div id="course">
       ...
       <div class="courseContent2">
        <div class="container">
            <div class="row" >
                <div class="col-md-8">
            <h3>{{ $t('courses.aboutprofession') }}</h3>
            <p>{{profession.overview}}</p>
            <br>
            <hr>
            <h3 style="margin-top:5%">{{ profession.syllabus_title }}</h3>
            <div class="row" data-aos="fade-up"
     data-aos-duration="1000" 
         data-aos-delay="200" v-for="(syllabus,index) in profession.syllabus_list" :key="index">
...
export default{
  ...
  methods: {
    getProfession(){
          axios.get(`http://localhost:8086/api/v1/professions/products/${this.id}`, {
            params: {
